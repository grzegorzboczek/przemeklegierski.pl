<?php /* Template Name: slubneWideo */ ?>

<!-- Load header -->
<?php get_header(); ?>
    <body <?php body_class(''); ?>
        <main>
            <section class="another-pages__hero">
                <!-- HAMBURGER MENU -->
                <!-- RWD FULL SCRN MENU  -->
            ...
            <section class="another-pages__gallery">
                <h2 class="another-pages__gallery-h2">Usługi Ślubne: <span class="h2-color">Wideo</span></h2>
