<?php /* Template Name: okazjonalneWydarzenia */ ?>
...
<?php get_header(); ?>
    <body <?php body_class(''); ?>
        <main>
            ...
            <?php 
                $args = array(
                    'post_type' => 'okazjonalne_wydarzen'
                );
            ...
            <section class="another-pages__gallery">
                <h2 class="another-pages__gallery-h2">Okazjonalne: <span class="h2-color">Wydarzenia</span></h2>
                <!-- First IMG -->
