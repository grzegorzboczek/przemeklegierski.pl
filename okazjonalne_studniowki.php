<?php /* Template Name: okazjonalneStudniowki */ ?>

<!-- Load header -->
<?php get_header(); ?>
    <body <?php body_class(''); ?>
        <main>
            <section class="another-pages__hero another-pages__hero-okazjonalne">
                <!-- HAMBURGER MENU -->
                <!-- RWD FULL SCRN MENU  -->
            ...
            <?php 
                $args = array(
                    'post_type' => 'okazjonalne_studniow'
                );
            ...
            <section class="another-pages__gallery">
                <h2 class="another-pages__gallery-h2">Okazjonalne: <span class="h2-color">Studniówki</span></h2>
                <!-- First IMG -->
                <img src="<?php the_field('1'); ?>" alt="" class="another-pages__gallery-img another-pages__gallery-img-first">
                <!-- All rest IMG -->
                <img src="<?php the_field('2'); ?>" alt="" class="another-pages__gallery-img">

                <img src="<?php the_field('3'); ?>" alt="" class="another-pages__gallery-img">

                <img src="<?php the_field('4'); ?>" alt="" class="another-pages__gallery-img">

                <img src="<?php the_field('5'); ?>" alt="" class="another-pages__gallery-img">

                <img src="<?php the_field('6'); ?>" alt="" class="another-pages__gallery-img">

                <img src="<?php the_field('7'); ?>" alt="" class="another-pages__gallery-img">

                <img src="<?php the_field('8'); ?>" alt="" class="another-pages__gallery-img another-pages__gallery-img-last">
            </section>
