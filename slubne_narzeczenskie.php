<?php /* Template Name: slubneNarzeczenskie */ ?>
...
<?php get_header(); ?>
    <body <?php body_class(''); ?>
        <main>
            ...
            <?php 
                $args = array(
                    'post_type' => 'slubne_narzeczenskie'
                );
            ...
            <section class="another-pages__gallery">
                <h2 class="another-pages__gallery-h2">Usługi Ślubne: <span class="h2-color">Narzeczeńskie</span></h2>
                <!-- First IMG -->
