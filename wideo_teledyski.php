<?php /* Template Name: wideoTeledyski */ ?>

<!-- Load header -->
<?php get_header(); ?>
    <body <?php body_class(''); ?>
        <main>
            <section class="another-pages__hero another-pages__hero-wideo">
                <!-- HAMBURGER MENU -->
                <!-- RWD FULL SCRN MENU  -->
            ...
            <section class="another-pages__gallery">
                <h2 class="another-pages__gallery-h2">Usługi Wideo: <span class="h2-color">Teledyski</span></h2>

                <!-- Check if have any video link -->
                <?php 
                $field1 = get_field('1');

                if ($field1 != '') { ?>
                    <iframe class="another-pages__wideo another-pages__wideo-first" width="560" height="315" src="<?php the_field('1'); ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                <?php } ?>
                ...
                if ($field2 != '') { ?>
                    <iframe class="another-pages__wideo" width="560" height="315" src="<?php echo $field2; ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                <?php } ?>
                ...
                if ($field3 != '') { ?>
                    <iframe class="another-pages__wideo" width="560" height="315" src="<?php echo $field3; ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                <?php } ?>
                ...
                if ($field4 != '') { ?>
                    <iframe class="another-pages__wideo" width="560" height="315" src="<?php echo $field4; ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                <?php } ?>
            ...
            <section class="another-pages__contact">
                ...
                © <?php echo date("Y"); ?> Przemysław Legierski. Wszelkie prawa zastrzeżone. | Zaprojektowane przez <a target="_blank" href="https://cyberwolfdesign.com/" class="another-pages__copy-link">Cyber Wolf Design.</a>
                </p>
            </section>
        </main>
